...
import { List, ListItem, ListItemText, ListItemAvatar, Avatar, Typography, ButtonGroup, Button } from "@mui/material";
    ...
    <>
      {cart.length > 0 ? (
        <>
          ...
          <Typography sx={{ display: "inline", fontSize: 20 }} component="h2" variant="body1" color="text.primary">
